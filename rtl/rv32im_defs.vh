...
`define RV32_EXCEPTION_INSTRUCTION_ACCESS_FAULT 4'd1
`define RV32_EXCEPTION_ILLEGAL_INSTRUCTION       4'd2
`define RV32_EXCEPTION_BREAKPOINT                4'd3
`define RV32_EXCEPTION_ENVIRONMENT_CALL          4'd11
